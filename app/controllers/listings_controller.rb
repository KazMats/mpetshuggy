class ListingsController < ApplicationController
 ...
 before_action :set_listing, only: [:update, :basics, :description, :address, :price, :photos, :calender, :bankaccount,
                                    :publish]
  ...
  def create
   ...
   @listing = current_user.listing.build(listing_params)
    ...
    if @listing.save
      ...
      redirect_to new_listings_path notice: "リスティングを作成・保存ができませんでした"
    end
